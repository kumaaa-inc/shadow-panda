...
<ComponentPreview name="badge" type="secondary" />

### Destructive

<ComponentPreview name="badge" type="destructive" />

### Outline

<ComponentPreview name="badge" type="outline" />

### With Icon

<ComponentPreview name="badge" type="with-icon" />
